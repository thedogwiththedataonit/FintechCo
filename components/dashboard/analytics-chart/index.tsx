...
import type { MockData, TimePeriod, AnalyticsChartDataPoint } from "@/types/dashboard";
...
export default function AnalyticsChart() {
  ...
  const renderChart = (data: AnalyticsChartDataPoint[]) => {
    return (
  ...
  return (
    ...
    >
      ...
      <TabsContent value="week" className="space-y-4">
        {renderChart(mockData.analytics.chartData.week)}
      </TabsContent>
      <TabsContent value="month" className="space-y-4">
        {renderChart(mockData.analytics.chartData.month)}
      </TabsContent>
      <TabsContent value="year" className="space-y-4">
        {renderChart(mockData.analytics.chartData.year)}
      </TabsContent>
    </Tabs>
  );
}
